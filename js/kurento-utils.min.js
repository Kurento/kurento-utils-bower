...
function noop(e){e&&console.error(e)}function trackStop(e){e.stop&&e.stop()}function streamStop(e){e.getTracks().forEach(trackStop)}function bufferizeCandidates(e,t){var n=[];return e.addEventListener("signalingstatechange",function(){if("stable"===this.signalingState)for(;n.length;){var e=n.shift();this.addIceCandidate(e.candidate,e.callback,e.callback)}}),function(r,i){switch(i=i||t,e.signalingState){case"closed":i(new Error("PeerConnection object is closed"));break;case"stable":if(e.remoteDescription){e.addIceCandidate(r,i,i);break}default:n.push({candidate:r,callback:i})}}}function WebRtcPeer(e,t,n){function r(){if(a){var e=p.getRemoteStreams()[0],t=e?URL.createObjectURL(e):"";a.src=t,console.log("Remote URL:",t)}}function i(){m.emit("streamended",this)}function o(){d&&s&&m.showLocalVideo(),d&&(d.addEventListener("ended",i),p.addStream(d)),l&&(l.addEventListener("ended",i),p.addStream(l)),"sendonly"==e&&(e="sendrecv"),n()}function c(e){getUserMedia(recursive(MEDIA_CONSTRAINTS,e),function(e){d=e,o()},n)}if(!(this instanceof WebRtcPeer))return new WebRtcPeer(e,t,n);WebRtcPeer.super_.call(this),t instanceof Function&&(n=t,t=void 0),t=t||{},n=(n||noop).bind(this);var s=t.localVideo,a=t.remoteVideo,d=t.videoStream,l=t.audioStream,f=t.mediaConstraints,u=t.connectionConstraints,p=t.peerConnection,v=t.sendSource||"webcam",b=recursive({iceServers:freeice()},t.configuration),h=t.onstreamended;h&&this.on("streamended",h);var g=t.onicecandidate;g&&this.on("icecandidate",g);var R=t.oncandidategatheringdone;R&&this.on("candidategatheringdone",R),p||(p=new RTCPeerConnection(b)),Object.defineProperty(this,"peerConnection",{get:function(){return p}}),Object.defineProperty(this,"currentFrame",{get:function(){if(a){if(a.readyState<a.HAVE_CURRENT_DATA)throw new Error("No video stream data available");var e=document.createElement("canvas");return e.width=a.videoWidth,e.height=a.videoHeight,e.getContext("2d").drawImage(a,0,0),e}}});var m=this,S=[],P=!1;p.addEventListener("icecandidate",function(e){var t=e.candidate;EventEmitter.listenerCount(m,"icecandidate")||EventEmitter.listenerCount(m,"candidategatheringdone")?t?(m.emit("icecandidate",t),P=!1):P||(m.emit("candidategatheringdone"),P=!0):P||(S.push(t),t||(P=!0))}),this.on("newListener",function(e,t){if("icecandidate"===e||"candidategatheringdone"===e)for(;S.length;){var n=S.shift();!n==("candidategatheringdone"===e)&&t(n)}});var y=bufferizeCandidates(p);this.addIceCandidate=function(e,t){var n=new RTCIceCandidate(e);console.log("ICE candidate received"),t=(t||noop).bind(this),y(n,t)},this.generateOffer=function(t){t=t.bind(this);var n=parser.getBrowser(),r="Firefox"===n.name&&n.version>34?{offerToReceiveAudio:"sendonly"!==e,offerToReceiveVideo:"sendonly"!==e}:{mandatory:{OfferToReceiveAudio:"sendonly"!==e,OfferToReceiveVideo:"sendonly"!==e},optional:[{DtlsSrtpKeyAgreement:!0}]},i=recursive(r,u);console.log("constraints: "+JSON.stringify(i)),p.createOffer(function(e){console.log("Created SDP offer"),p.setLocalDescription(e,function(){console.log("Local description set",e.sdp),t(null,e.sdp,m.processAnswer.bind(m))},t)},t,i)},this.getLocalSessionDescriptor=function(){return p.localDescription},this.getRemoteSessionDescriptor=function(){return p.remoteDescription},this.showLocalVideo=function(){s.src=URL.createObjectURL(d),s.muted=!0},this.processAnswer=function(e,t){t=(t||noop).bind(this);var n=new RTCSessionDescription({type:"answer",sdp:e});return console.log("SDP answer received, setting remote description"),"closed"==p.signalingState?t("PeerConnection is closed"):void p.setRemoteDescription(n,function(){r(),t()},t)},this.processOffer=function(e,t){t=t.bind(this);var n=new RTCSessionDescription({type:"offer",sdp:e});return console.log("SDP offer received, setting remote description"),"closed"==p.signalingState?t("PeerConnection is closed"):void p.setRemoteDescription(n,function(){r();var e=recursive({},u);console.log("constraints: "+JSON.stringify(e)),p.createAnswer(function(e){console.log("Created SDP answer"),p.setLocalDescription(e,function(){console.log("Local description set",e.sdp),t(null,e.sdp)},t)},t,e)},t)},"recvonly"===e||d||l?setTimeout(o,0):"webcam"==v||f?c(f):getScreenConstraints(sendMode,function(e,t){return e?n(e):void c(t)}),this.on("_dispose",function(){s&&(s.src=""),a&&(a.src="")})}function createEnableDescriptor(e){var t="get"+e+"Tracks";return{enumerable:!0,get:function(){if(this.peerConnection){var e=this.peerConnection.getLocalStreams();if(e.length){for(var n,r=0;n=e[r];r++)for(var i,o=n[t](),c=0;i=o[c];c++)if(!i.enabled)return!1;return!0}}},set:function(e){function n(t){t.enabled=e}this.peerConnection.getLocalStreams().forEach(function(e){e[t]().forEach(n)})}}}function WebRtcPeerRecvonly(e,t){return this instanceof WebRtcPeerRecvonly?void WebRtcPeerRecvonly.super_.call(this,"recvonly",e,t):new WebRtcPeerRecvonly(e,t)}function WebRtcPeerSendonly(e,t){return this instanceof WebRtcPeerSendonly?void WebRtcPeerSendonly.super_.call(this,"sendonly",e,t):new WebRtcPeerSendonly(e,t)}function WebRtcPeerSendrecv(e,t){return this instanceof WebRtcPeerSendrecv?void WebRtcPeerSendrecv.super_.call(this,"sendrecv",e,t):new WebRtcPeerSendrecv(e,t)}var freeice=require("freeice"),inherits=require("inherits"),UAParser=require("ua-parser-js"),EventEmitter=require("events").EventEmitter,recursive=require("merge").recursive,MEDIA_CONSTRAINTS={audio:!0,video:{mandatory:{maxWidth:640,maxFrameRate:15,minFrameRate:15}}},parser=new UAParser;inherits(WebRtcPeer,EventEmitter),Object.defineProperty(WebRtcPeer.prototype,"enabled",{enumerable:!0,get:function(){return this.audioEnabled&&this.videoEnabled},set:function(e){this.audioEnabled=this.videoEnabled=e}}),Object.defineProperty(WebRtcPeer.prototype,"audioEnabled",createEnableDescriptor("Audio")),Object.defineProperty(WebRtcPeer.prototype,"videoEnabled",createEnableDescriptor("Video")),WebRtcPeer.prototype.getLocalStream=function(e){return this.peerConnection?this.peerConnection.getLocalStreams()[e||0]:void 0},WebRtcPeer.prototype.getRemoteStream=function(e){return this.peerConnection?this.peerConnection.getRemoteStreams()[e||0]:void 0},WebRtcPeer.prototype.dispose=function(){console.log("Disposing WebRtcPeer");var e=this.peerConnection;if(e){if("closed"==e.signalingState)return;e.getLocalStreams().forEach(streamStop),e.close()}this.emit("_dispose")},inherits(WebRtcPeerRecvonly,WebRtcPeer),inherits(WebRtcPeerSendonly,WebRtcPeer),inherits(WebRtcPeerSendrecv,WebRtcPeer),exports.bufferizeCandidates=bufferizeCandidates,exports.WebRtcPeerRecvonly=WebRtcPeerRecvonly,exports.WebRtcPeerSendonly=WebRtcPeerSendonly,exports.WebRtcPeerSendrecv=WebRtcPeerSendrecv;
