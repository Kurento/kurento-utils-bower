...
function noop(e){e&&console.error(e)}function trackStop(e){e.stop&&e.stop()}function streamStop(e){e.getTracks().forEach(trackStop)}function bufferizeCandidates(e,n){var t=[];return e.addEventListener("signalingstatechange",function(){if("stable"===this.signalingState)for(;t.length;){var e=t.shift();this.addIceCandidate(e.candidate,e.callback,e.callback)}}),function(r,o){switch(o=o||n,e.signalingState){case"closed":o(new Error("PeerConnection object is closed"));break;case"stable":if(e.remoteDescription){e.addIceCandidate(r,o,o);break}default:t.push({candidate:r,callback:o})}}}function removeFIDFromOffer(e){var n=e.indexOf("a=ssrc-group:FID");return n>0?e.slice(0,n):e}function getSimulcastInfo(e){var n=e.getVideoTracks();if(!n.length)return console.warn("No video tracks available in the video stream"),"";var t=["a=x-google-flag:conference","a=ssrc-group:SIM 1 2 3","a=ssrc:1 cname:localVideo","a=ssrc:1 msid:"+e.id+" "+n[0].id,"a=ssrc:1 mslabel:"+e.id,"a=ssrc:1 label:"+n[0].id,"a=ssrc:2 cname:localVideo","a=ssrc:2 msid:"+e.id+" "+n[0].id,"a=ssrc:2 mslabel:"+e.id,"a=ssrc:2 label:"+n[0].id,"a=ssrc:3 cname:localVideo","a=ssrc:3 msid:"+e.id+" "+n[0].id,"a=ssrc:3 mslabel:"+e.id,"a=ssrc:3 label:"+n[0].id];return t.push(""),t.join("\n")}function WebRtcPeer(e,n,t){function r(){if(d){var e=v.getRemoteStreams()[0],n=e?URL.createObjectURL(e):"";d.pause(),d.src=n,d.load(),console.log("Remote URL:",n)}}function o(e){return R&&("Chrome"===browser.name||"Chromium"===browser.name?(console.log("Adding multicast info"),e=new RTCSessionDescription({type:e.type,sdp:removeFIDFromOffer(e.sdp)+getSimulcastInfo(l)})):console.warn("Simulcast is only available in Chrome browser.")),e}function i(){C.emit("streamended",this)}function a(){"closed"===v.signalingState&&t('The peer connection object is in "closed" state. This is most likely due to an invocation of the dispose method before accepting in the dialogue'),l&&c&&C.showLocalVideo(),l&&(l.addEventListener("ended",i),v.addStream(l)),u&&(u.addEventListener("ended",i),v.addStream(u));var n=parser.getBrowser();"sendonly"!==e||"Chrome"!==n.name&&"Chromium"!==n.name||39!==n.major||(e="sendrecv"),t()}function s(e){void 0===e&&(e=MEDIA_CONSTRAINTS),getUserMedia(e,function(e){l=e,a()},t)}if(!(this instanceof WebRtcPeer))return new WebRtcPeer(e,n,t);WebRtcPeer.super_.call(this),n instanceof Function&&(t=n,n=void 0),n=n||{},t=(t||noop).bind(this);var c=n.localVideo,d=n.remoteVideo,l=n.videoStream,u=n.audioStream,f=n.mediaConstraints,p=n.connectionConstraints,v=n.peerConnection,h=n.sendSource||"webcam",g=uuid.v4(),m=recursive({iceServers:freeice()},n.configuration),b=n.onstreamended;b&&this.on("streamended",b);var P=n.onicecandidate;P&&this.on("icecandidate",P);var S=n.oncandidategatheringdone;S&&this.on("candidategatheringdone",S);var R=n.simulcast,w=new sdpTranslator.Interop;v||(v=new RTCPeerConnection(m)),Object.defineProperties(this,{peerConnection:{get:function(){return v}},id:{value:n.id||g,writable:!1},remoteVideo:{get:function(){return d}},localVideo:{get:function(){return c}},currentFrame:{get:function(){if(d){if(d.readyState<d.HAVE_CURRENT_DATA)throw new Error("No video stream data available");var e=document.createElement("canvas");return e.width=d.videoWidth,e.height=d.videoHeight,e.getContext("2d").drawImage(d,0,0),e}}}});var C=this,y=[],E=!1;v.addEventListener("icecandidate",function(e){var n=e.candidate;if(EventEmitter.listenerCount(C,"icecandidate")||EventEmitter.listenerCount(C,"candidategatheringdone"))if(n){var t;t=usePlanB?w.candidateToUnifiedPlan(n):n,C.emit("icecandidate",t),E=!1}else E||(C.emit("candidategatheringdone"),E=!0);else E||(y.push(n),n||(E=!0))}),v.onaddstream=n.onaddstream,v.onnegotiationneeded=n.onnegotiationneeded,this.on("newListener",function(e,n){if("icecandidate"===e||"candidategatheringdone"===e)for(;y.length;){var t=y.shift();!t==("candidategatheringdone"===e)&&n(t)}});var D=bufferizeCandidates(v);this.addIceCandidate=function(e,n){var t;t=usePlanB?w.candidateToPlanB(e):new RTCIceCandidate(e),console.log("ICE candidate received"),n=(n||noop).bind(this),D(t,n)},this.generateOffer=function(n){n=n.bind(this);var t=!0,r=!0;f&&(t="boolean"==typeof f.audio?f.audio:!0,r="boolean"==typeof f.video?f.video:!0);var i="Firefox"===browser.name&&browser.version>34?{offerToReceiveAudio:"sendonly"!==e&&t,offerToReceiveVideo:"sendonly"!==e&&r}:{mandatory:{OfferToReceiveAudio:"sendonly"!==e&&t,OfferToReceiveVideo:"sendonly"!==e&&r},optional:[{DtlsSrtpKeyAgreement:!0}]},a=recursive(i,p);console.log("constraints: "+JSON.stringify(a)),v.createOffer(function(e){console.log("Created SDP offer"),e=o(e),v.setLocalDescription(e,function(){if(console.log("Local description set",e.sdp),usePlanB){var t=w.toUnifiedPlan(e);console.log("offer::origPlanB->UnifiedPlan",dumpSDP(t)),e=t}n(null,e.sdp,C.processAnswer.bind(C))},n)},n,a)},this.getLocalSessionDescriptor=function(){return v.localDescription},this.getRemoteSessionDescriptor=function(){return v.remoteDescription},this.showLocalVideo=function(){c.src=URL.createObjectURL(l),c.muted=!0},this.processAnswer=function(e,n){n=(n||noop).bind(this);var t=new RTCSessionDescription({type:"answer",sdp:e});if(usePlanB){var o=w.toPlanB(t);console.log("asnwer::planB",dumpSDP(o)),t=o}return console.log("SDP answer received, setting remote description"),"closed"===v.signalingState?n("PeerConnection is closed"):void v.setRemoteDescription(t,function(){r(),n()},n)},this.processOffer=function(e,n){n=n.bind(this);var t=new RTCSessionDescription({type:"offer",sdp:e});if(usePlanB){var i=w.toPlanB(t);console.log("offer::planB",dumpSDP(i)),t=i}return console.log("SDP offer received, setting remote description"),"closed"===v.signalingState?n("PeerConnection is closed"):void v.setRemoteDescription(t,function(){r(),v.createAnswer(function(e){e=o(e),console.log("Created SDP answer"),v.setLocalDescription(e,function(){if(console.log("Local description set",e.sdp),usePlanB){var t=w.toUnifiedPlan(e);console.log("answer::origPlanB->UnifiedPlan",dumpSDP(t)),e=t}n(null,e.sdp)},n)},n)},n)},"recvonly"===e||l||u?setTimeout(a,0):"webcam"===h?s(f):getScreenConstraints(h,function(e,n){return e?t(e):(constraints=[f],constraints.unshift(n),void s(recursive.apply(void 0,constraints)))},g),this.on("_dispose",function(){c&&(c.pause(),c.src="",c.load()),d&&(d.pause(),d.src="",d.load()),C.removeAllListeners(),void 0!==window.cancelChooseDesktopMedia&&window.cancelChooseDesktopMedia(g)})}function createEnableDescriptor(e){var n="get"+e+"Tracks";return{enumerable:!0,get:function(){if(this.peerConnection){var e=this.peerConnection.getLocalStreams();if(e.length){for(var t,r=0;t=e[r];r++)for(var o,i=t[n](),a=0;o=i[a];a++)if(!o.enabled)return!1;return!0}}},set:function(e){function t(n){n.enabled=e}this.peerConnection.getLocalStreams().forEach(function(e){e[n]().forEach(t)})}}}function WebRtcPeerRecvonly(e,n){return this instanceof WebRtcPeerRecvonly?void WebRtcPeerRecvonly.super_.call(this,"recvonly",e,n):new WebRtcPeerRecvonly(e,n)}function WebRtcPeerSendonly(e,n){return this instanceof WebRtcPeerSendonly?void WebRtcPeerSendonly.super_.call(this,"sendonly",e,n):new WebRtcPeerSendonly(e,n)}function WebRtcPeerSendrecv(e,n){return this instanceof WebRtcPeerSendrecv?void WebRtcPeerSendrecv.super_.call(this,"sendrecv",e,n):new WebRtcPeerSendrecv(e,n)}function harkUtils(e,n){return hark(e,n)}var freeice=require("freeice"),inherits=require("inherits"),UAParser=require("ua-parser-js"),uuid=require("uuid"),hark=require("hark"),EventEmitter=require("events").EventEmitter,recursive=require("merge").recursive.bind(void 0,!0),sdpTranslator=require("sdp-translator");try{require("kurento-browser-extensions")}catch(error){"undefined"==typeof getScreenConstraints&&(console.warn("screen sharing is not available"),getScreenConstraints=function(e,n){n(new Error("This library is not enabled for screen sharing"))})}var MEDIA_CONSTRAINTS={audio:!0,video:{width:640,framerate:15}},ua=window&&window.navigator?window.navigator.userAgent:"",parser=new UAParser(ua),browser=parser.getBrowser(),usePlanB=!1;("Chrome"===browser.name||"Chromium"===browser.name)&&(console.log(browser.name+": using SDP PlanB"),usePlanB=!0);var dumpSDP=function(e){return"undefined"==typeof e||null===e?"":"type: "+e.type+"\r\n"+e.sdp};inherits(WebRtcPeer,EventEmitter),Object.defineProperties(WebRtcPeer.prototype,{enabled:{enumerable:!0,get:function(){return this.audioEnabled&&this.videoEnabled},set:function(e){this.audioEnabled=this.videoEnabled=e}},audioEnabled:createEnableDescriptor("Audio"),videoEnabled:createEnableDescriptor("Video")}),WebRtcPeer.prototype.getLocalStream=function(e){return this.peerConnection?this.peerConnection.getLocalStreams()[e||0]:void 0},WebRtcPeer.prototype.getRemoteStream=function(e){return this.peerConnection?this.peerConnection.getRemoteStreams()[e||0]:void 0},WebRtcPeer.prototype.dispose=function(){console.log("Disposing WebRtcPeer");var e=this.peerConnection;try{if(e){if("closed"===e.signalingState)return;e.getLocalStreams().forEach(streamStop),e.close()}}catch(n){console.warn("Exception disposing webrtc peer "+n)}this.emit("_dispose")},inherits(WebRtcPeerRecvonly,WebRtcPeer),inherits(WebRtcPeerSendonly,WebRtcPeer),inherits(WebRtcPeerSendrecv,WebRtcPeer),exports.bufferizeCandidates=bufferizeCandidates,exports.WebRtcPeerRecvonly=WebRtcPeerRecvonly,exports.WebRtcPeerSendonly=WebRtcPeerSendonly,exports.WebRtcPeerSendrecv=WebRtcPeerSendrecv,exports.hark=harkUtils;
...
module.exports=function r(t){if(!t)return!1;if(this.length!=t.length)return!1;for(var e=0,n=this.length;n>e;e++)if(this[e]instanceof Array&&t[e]instanceof Array){if(!r.apply(this[e],[t[e]]))return!1}else if(this[e]!=t[e])return!1;return!0};
},{}],18:[function(require,module,exports){
exports.Interop=require("./interop");
},{"./interop":19}],19:[function(require,module,exports){
"use strict";function Interop(){this.cache={mlB2UMap:{},mlU2BMap:{}}}var transform=require("./transform"),arrayEquals=require("./array-equals");module.exports=Interop,Interop.prototype.candidateToUnifiedPlan=function(e){var r=new RTCIceCandidate(e);return r.sdpMLineIndex=this.cache.mlB2UMap[r.sdpMLineIndex],r},Interop.prototype.candidateToPlanB=function(e){var r=new RTCIceCandidate(e);if(0===r.sdpMid.indexOf("audio"))r.sdpMid="audio";else{if(0!==r.sdpMid.indexOf("video"))throw new Error("candidate with "+r.sdpMid+" not allowed");r.sdpMid="video"}return r.sdpMLineIndex=this.cache.mlU2BMap[r.sdpMLineIndex],r},Interop.prototype.getFirstSendingIndexFromAnswer=function(e){if(!this.cache.answer)return null;var r=transform.parse(this.cache.answer);if(r&&r.media&&Array.isArray(r.media))for(var i=0;i<r.media.length;i++)if(r.media[i].type==e&&(!r.media[i].direction||"sendrecv"===r.media[i].direction||"sendonly"===r.media[i].direction))return i;return null},Interop.prototype.toPlanB=function(e){var r=this;if("object"!=typeof e||null===e||"string"!=typeof e.sdp)return console.warn("An empty description was passed as an argument."),e;var i=transform.parse(e.sdp);if("undefined"==typeof i.media||!Array.isArray(i.media)||0===i.media.length)return console.warn("The description has no media."),e;if(i.media.length<=3&&i.media.every(function(e){return-1!==["video","audio","data"].indexOf(e.mid)}))return console.warn("This description does not look like Unified Plan."),e;for(var n=e.sdp,t=!1,o=0;o<i.media.length;o++){var d=i.media[o];d.rtp.forEach(function(e){if("NULL"===e.codec){t=!0;var i=transform.parse(r.cache.offer);e.codec=i.media[o].rtp[0].codec}})}t&&(n=transform.write(i)),this.cache[e.type]=n;var s=i.media;i.media=[];var a={},c=[];s.forEach(function(e){if(("string"!=typeof e.rtcpMux||"rtcp-mux"!==e.rtcpMux)&&"inactive"!==e.direction)throw new Error("Cannot convert to Plan B because m-lines without the rtcp-mux attribute were found.");("undefined"==typeof a[e.type]||"inactive"===a[e.type].direction)&&(a[e.type]=e)}),s.forEach(function(e){return"application"===e.type?(i.media.push(e),void c.push(e.mid)):("object"==typeof e.sources&&Object.keys(e.sources).forEach(function(r){"object"!=typeof a[e.type].sources&&(a[e.type].sources={}),a[e.type].sources[r]=e.sources[r],"undefined"!=typeof e.msid&&(a[e.type].sources[r].msid=e.msid)}),"undefined"!=typeof e.ssrcGroups&&Array.isArray(e.ssrcGroups)&&("undefined"!=typeof a[e.type].ssrcGroups&&Array.isArray(a[e.type].ssrcGroups)||(a[e.type].ssrcGroups=[]),a[e.type].ssrcGroups=a[e.type].ssrcGroups.concat(e.ssrcGroups)),void(a[e.type]===e&&(e.mid=e.type,delete e.bundleOnly,delete e.msid,"inactive"!==e.direction&&c.push(e.type),i.media.push(e))))}),i.groups.some(function(e){return"BUNDLE"===e.type?(e.mids=c.join(" "),!0):void 0}),i.msidSemantic={semantic:"WMS",token:"*"};var p=transform.write(i);return new RTCSessionDescription({type:e.type,sdp:p})},Interop.prototype.toUnifiedPlan=function(e){var r=this;if("object"!=typeof e||null===e||"string"!=typeof e.sdp)return console.warn("An empty description was passed as an argument."),e;var i=transform.parse(e.sdp);if("undefined"==typeof i.media||!Array.isArray(i.media)||0===i.media.length)return console.warn("The description has no media."),e;if(i.media.length>3||!i.media.every(function(e){return-1!==["video","audio","data"].indexOf(e.mid)}))return console.warn("This description does not look like Plan B."),e;var n=[];i.media.forEach(function(e){n.push(e.mid)});var t=!1;if("undefined"!=typeof i.groups&&Array.isArray(i.groups)&&(t=i.groups.every(function(e){return"BUNDLE"!==e.type||arrayEquals.apply(e.mids.sort(),[n.sort()])})),!t)throw new Error("Cannot convert to Unified Plan because m-lines that are not bundled were found.");var o;if("answer"===e.type)o="offer";else{if("offer"!==e.type)throw new Error("Type '"+e.type+"' not supported.");o="answer"}var d;"undefined"!=typeof this.cache[o]&&(d=transform.parse(this.cache[o]));var s,a,c,p,f={audio:{},video:{}},u={},y=0,m=0,l={},h={},v={},w={};if(i.media.forEach(function(i){if(("string"!=typeof i.rtcpMux||"rtcp-mux"!==i.rtcpMux)&&"inactive"!==i.direction)throw new Error("Cannot convert to Unified Plan because m-lines without the rtcp-mux attribute were found.");if("application"===i.type)return void(u[i.mid]=i);var n=i.sources,t=i.ssrcGroups,o=i.port;if("undefined"!=typeof s&&"undefined"!=typeof i.candidates&&s!=i.candidates)throw new Error("Only BUNDLE supported, candidates must be the same for all m-lines.\n	Last candidates: "+JSON.stringify(s)+"\n	New candidates: "+JSON.stringify(i.candidates));if("undefined"!=i.candidates&&(s=i.candidates),"undefined"!=typeof a&&"undefined"!=typeof i.iceUfrag&&a!=i.iceUfrag)throw new Error("Only BUNDLE supported, iceUfrag must be the same for all m-lines.\n	Last iceUfrag: "+a+"\n	New iceUfrag: "+i.iceUfrag);if("undefined"!=i.iceUfrag&&(a=i.iceUfrag),"undefined"!=typeof c&&"undefined"!=typeof i.icePwd&&c!=i.icePwd)throw new Error("Only BUNDLE supported, icePwd must be the same for all m-lines.\n	Last icePwd: "+c+"\n	New icePwd: "+i.icePwd);if("undefined"!=i.icePwd&&(c=i.icePwd),"undefined"!=typeof p&&"undefined"!=typeof i.fingerprint&&(p.type!=i.fingerprint.type||p.hash!=i.fingerprint.hash))throw new Error("Only BUNDLE supported, fingerprint must be the same for all m-lines.\n	Last fingerprint: "+JSON.stringify(p)+"\n	New fingerprint: "+JSON.stringify(i.fingerprint));"undefined"!=i.fingerprint&&(p=i.fingerprint),h[i.type]=i.payloads,v[i.type]=i.rtcpFb,w[i.type]=i.rtp,delete i.sources,delete i.ssrcGroups,delete i.candidates,delete i.iceUfrag,delete i.icePwd,delete i.fingerprint,delete i.port,delete i.mid;var g={};"undefined"!=typeof t&&Array.isArray(t)&&t.forEach(function(e){"SIM"!==e.semantics&&"undefined"!=typeof e.ssrcs&&Array.isArray(e.ssrcs)&&e.ssrcs.forEach(function(r){"undefined"==typeof g[r]&&(g[r]=[]),g[r].push(e)})});var E={};"object"==typeof n&&Object.keys(n).forEach(function(t){var h;return"offer"!==e.type||n[t].msid?("undefined"!=typeof g[t]&&Array.isArray(g[t])&&g[t].some(function(e){return e.ssrcs.some(function(e){return"object"==typeof E[e]?(h=E[e],!0):void 0})}),void("object"==typeof h?(h.sources[t]=n[t],delete n[t].msid):(h=Object.create(i),E[t]=h,"undefined"!=typeof n[t].msid&&(h.msid=n[t].msid,delete n[t].msid),h.sources={},h.sources[t]=n[t],h.ssrcGroups=g[t],"undefined"!=typeof d&&"undefined"!=typeof d.media&&Array.isArray(d.media)&&d.media.forEach(function(e){"object"==typeof e.sources&&Object.keys(e.sources).forEach(function(r){r===t&&(h.mid=e.mid)})}),"undefined"==typeof h.mid&&(h.mid=[i.type,"-",t].join("")),h.candidates=s,h.iceUfrag=a,h.icePwd=c,h.fingerprint=p,h.port=o,u[h.mid]=h,l[m]=h.sources,r.cache.mlU2BMap[m]=y,"undefined"==typeof r.cache.mlB2UMap[y]&&(r.cache.mlB2UMap[y]=m),m++))):void(f[i.type][t]=n[t])}),y++}),i.media=[],n=[],"answer"===e.type)for(var g=0;g<d.media.length;g++){var E=d.media[g];"undefined"==typeof u[E.mid]&&(delete E.msid,delete E.sources,delete E.ssrcGroups,"undefined"==typeof l[g]&&(E.direction&&"sendrecv"!==E.direction?"sendonly"===E.direction&&(E.direction="inactive"):E.direction="recvonly"),E.sources=l[g],E.candidates=s,E.iceUfrag=a,E.icePwd=c,E.fingerprint=p,E.rtp=w[E.type],E.payloads=h[E.type],E.rtcpFb=v[E.type]),i.media.push(E),"string"==typeof E.mid&&n.push(E.mid)}else"undefined"!=typeof d&&"undefined"!=typeof d.media&&Array.isArray(d.media)&&d.media.forEach(function(e){n.push(e.mid),"undefined"!=typeof u[e.mid]?i.media.push(u[e.mid]):(delete e.msid,delete e.sources,delete e.ssrcGroups,e.direction&&"sendrecv"!==e.direction||(e.direction="recvonly"),e.direction&&"sendonly"!==e.direction||(e.direction="inactive"),i.media.push(e))}),Object.keys(u).forEach(function(e){-1===n.indexOf(e)&&(n.push(e),"recvonly"===u[e].direction?i.media.some(function(r){return"sendrecv"!==r.direction&&"sendonly"!==r.direction||r.type!==u[e].type?void 0:(Object.keys(u[e].sources).forEach(function(i){r.sources[i]=u[e].sources[i]}),!0)}):i.media.push(u[e]))});["audio","video"].forEach(function(e){if(i&&i.media&&Array.isArray(i.media)){var n=null;if(Object.keys(f[e]).length>0&&(n=r.getFirstSendingIndexFromAnswer(e),null===n))for(var t=0;t<i.media.length;t++)if(i.media[t].type===e){n=t;break}if(n&&i.media.length>n){var o=i.media[n];Object.keys(f[e]).forEach(function(r){o.sources&&o.sources[r]&&console.warn("Replacing an existing SSRC."),o.sources||(o.sources={}),o.sources[r]=f[e][r]})}}}),i.groups.some(function(e){return"BUNDLE"===e.type?(e.mids=n.join(" "),!0):void 0}),i.msidSemantic={semantic:"WMS",token:"*"};var U=transform.write(i);return this.cache[e.type]=U,new RTCSessionDescription({type:e.type,sdp:U})};
...
function WildEmitter(){}module.exports=WildEmitter,WildEmitter.mixin=function(t){var l=t.prototype||t;l.isWildEmitter=!0,l.on=function(t,l,s){this.callbacks=this.callbacks||{};var i=3===arguments.length,a=i?arguments[1]:void 0,c=i?arguments[2]:arguments[1];return c._groupName=a,(this.callbacks[t]=this.callbacks[t]||[]).push(c),this},l.once=function(t,l,s){function i(){a.off(t,i),n.apply(this,arguments)}var a=this,c=3===arguments.length,e=c?arguments[1]:void 0,n=c?arguments[2]:arguments[1];return this.on(t,e,i),this},l.releaseGroup=function(t){this.callbacks=this.callbacks||{};var l,s,i,a;for(l in this.callbacks)for(a=this.callbacks[l],s=0,i=a.length;i>s;s++)a[s]._groupName===t&&(a.splice(s,1),s--,i--);return this},l.off=function(t,l){this.callbacks=this.callbacks||{};var s,i=this.callbacks[t];return i?1===arguments.length?(delete this.callbacks[t],this):(s=i.indexOf(l),i.splice(s,1),0===i.length&&delete this.callbacks[t],this):this},l.emit=function(t){this.callbacks=this.callbacks||{};var l,s,i,a=[].slice.call(arguments,1),c=this.callbacks[t],e=this.getWildcardCallbacks(t);if(c)for(i=c.slice(),l=0,s=i.length;s>l&&i[l];++l)i[l].apply(this,a);if(e)for(s=e.length,i=e.slice(),l=0,s=i.length;s>l&&i[l];++l)i[l].apply(this,[t].concat(a));return this},l.getWildcardCallbacks=function(t){this.callbacks=this.callbacks||{};var l,s,i=[];for(l in this.callbacks)s=l.split("*"),("*"===l||2===s.length&&t.slice(0,s[0].length)===s[0])&&(i=i.concat(this.callbacks[l]));return i}},WildEmitter.mixin(WildEmitter);
},{}]},{},[2])(2)
});
