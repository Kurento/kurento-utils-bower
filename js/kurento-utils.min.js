...
function noop(e){e&&console.error(e)}function trackStop(e){e.stop&&e.stop()}function streamStop(e){e.getTracks().forEach(trackStop)}function bufferizeCandidates(e,t){function n(){if("stable"===this.signalingState)for(;r.length;){var e=r.shift();this.addIceCandidate(e.candidate,e.callback,e.callback)}this.removeEventListener("signalingstatechange",n)}var r=[];return e.addEventListener("signalingstatechange",n),function(n,i){switch(i=i||t,e.signalingState){case"closed":i(new Error("PeerConnection object is closed"));break;case"stable":if(e.remoteDescription){e.addIceCandidate(n,i,i);break}default:r.push({candidate:n,callback:i})}}}function WebRtcPeer(e,t,n){function r(){P.emit("streamended",this)}function i(e){function t(e){var n=e.candidate;EventEmitter.listenerCount(P,"icecandidate")||EventEmitter.listenerCount(P,"candidategatheringdone")?n?P.emit("icecandidate",n):P.emit("candidategatheringdone"):i.push(n),n||this.removeEventListener("icecandidate",t)}var n=new RTCPeerConnection(e);E=bufferizeCandidates(n);var i=[];return P.on("newListener",function(e,t){if("icecandidate"===e||"candidategatheringdone"===e)for(;i.length;){var n=i.shift();!n==("candidategatheringdone"===e)&&t(n)}}),n.addEventListener("icecandidate",t),n.addEventListener("iceconnectionstatechange",o),l&&(l.addEventListener("ended",r),n.addStream(l)),u&&(u.addEventListener("ended",r),n.addStream(u)),n}function o(){if("connected"===this.iceConnectionState||"completed"===this.iceConnectionState){if(this.removeEventListener("iceconnectionstatechange",o),d){if(d.readyState>=d.HAVE_CURRENT_DATA){var e=d.style,t=e.backgroundImage;e.backgroundImage="url('"+P.currentFrame.toDataURL()+"')",t&&d.addEventListener("playing",function n(){d.removeEventListener("playing",n),e.backgroundImage=t})}d.src=URL.createObjectURL(this.getRemoteStreams()[0]),console.log("Remote URL: "+d.src)}S&&S.close(),S=this,P.emit("connected")}}function r(){P.emit("streamended",this)}function c(){"closed"===S.signalingState&&n('The peer connection object is in "closed" state. This is most likely due to an invocation of the dispose method before accepting in the dialogue'),l&&s&&P.showLocalVideo(),l&&(l.addEventListener("ended",r),S.addStream(l)),u&&(u.addEventListener("ended",r),S.addStream(u)),"sendonly"===e&&(e="sendrecv"),n()}function a(e){e=Array.prototype.slice.call(arguments),e.unshift(MEDIA_CONSTRAINTS),getUserMedia(recursive.apply(void 0,e),function(e){l=e,c()},n)}if(!(this instanceof WebRtcPeer))return new WebRtcPeer(e,t,n);WebRtcPeer.super_.call(this),t instanceof Function&&(n=t,t=void 0),t=t||{},n=(n||noop).bind(this);var s=t.localVideo,d=t.remoteVideo,l=t.videoStream,u=t.audioStream,f=t.mediaConstraints,v=(t.connectionConstraints,t.sendSource||"webcam"),h=uuid.v4(),g=recursive({iceServers:freeice()},t.configuration),p=t.onstreamended;p&&this.on("streamended",p);var b=t.onicecandidate;b&&this.on("icecandidate",b);var m=t.oncandidategatheringdone;m&&this.on("candidategatheringdone",m);var R,S=t.peerConnection;Object.defineProperties(this,{peerConnection:{get:function(){return S}},remoteVideo:{get:function(){return d}},localVideo:{get:function(){return s}},currentFrame:{get:function(){if(d){if(d.readyState<d.HAVE_CURRENT_DATA)throw new Error("No video stream data available");var e=document.createElement("canvas");return e.width=d.videoWidth,e.height=d.videoHeight,e.getContext("2d").drawImage(d,0,0),e}}}});var E,P=this;this.addIceCandidate=function(e,t){var n=new RTCIceCandidate(e);console.log("ICE candidate received"),t=(t||noop).bind(this),E(n,t)},this.generateOffer=function(e){e=e.bind(this),R=i(g);var t=parser.getBrowser();"Firefox"===t.name&&t.version>34;console.log("constraints:",constraints),R.createOffer(function(t){console.log("Created SDP offer"),R.setLocalDescription(t,function(){console.log("Local description set:",t.sdp),e(null,t.sdp,P.processAnswer.bind(P))},e)},e,constraints)},this.showLocalVideo=function(){s.src=URL.createObjectURL(l),s.muted=!0},this.processAnswer=function(e,t){t=(t||noop).bind(this);var n=new RTCSessionDescription({type:"answer",sdp:e});return console.log("SDP answer received, setting remote description"),"closed"===R.signalingState?t("PeerConnection is closed"):void R.setRemoteDescription(n,t,t)},this.processOffer=function(e,t){t=t.bind(this);var n=new RTCSessionDescription({type:"offer",sdp:e});console.log("SDP offer received, setting remote description"),R=i(g),R.setRemoteDescription(n,function(){R.createAnswer(function(e){console.log("Created SDP answer"),R.setLocalDescription(e,function(){console.log("Local description set",e.sdp),t(null,e.sdp)},t)},t)},t)},"recvonly"===e||l||u?setTimeout(c,0):"webcam"===v?a(f):getScreenConstraints(v,function(e,t){return e?n(e):void a(t,f)},h),this.dispose=function(){if(console.log("Disposing WebRtcPeer"),S){if("closed"===S.signalingState)return;S.getLocalStreams().forEach(streamStop),S.close(),S=void 0}s&&(s.pause(),s.src="",s.load()),d&&(d.pause(),d.src="",d.load()),P.removeAllListeners(),void 0!==window.cancelChooseDesktopMedia&&window.cancelChooseDesktopMedia(h)}}function trackSetEnable(e){e.enabled=this.valueOf()}function createEnableDescriptor(e){var t="get"+e+"Tracks";return{enumerable:!0,get:function(){if(this.peerConnection){var e=this.peerConnection.getLocalStreams();if(e.length){for(var n,r=0;n=e[r];r++)for(var i,o=n[t](),c=0;i=o[c];c++)if(!i.enabled)return!1;return!0}}},set:function(e){this.peerConnection.getLocalStreams().forEach(function(n){n[t]().forEach(trackSetEnable,e)})}}}function WebRtcPeerRecvonly(e,t){return this instanceof WebRtcPeerRecvonly?void WebRtcPeerRecvonly.super_.call(this,"recvonly",e,t):new WebRtcPeerRecvonly(e,t)}function WebRtcPeerSendonly(e,t){return this instanceof WebRtcPeerSendonly?void WebRtcPeerSendonly.super_.call(this,"sendonly",e,t):new WebRtcPeerSendonly(e,t)}function WebRtcPeerSendrecv(e,t){return this instanceof WebRtcPeerSendrecv?void WebRtcPeerSendrecv.super_.call(this,"sendrecv",e,t):new WebRtcPeerSendrecv(e,t)}var freeice=require("freeice"),inherits=require("inherits"),UAParser=require("ua-parser-js"),uuid=require("uuid"),EventEmitter=require("events").EventEmitter,recursive=require("merge").recursive.bind(void 0,!0);try{!function(){throw new Error("Cannot find module 'kurento-browser-extensions' from '/var/lib/jenkins/workspace/Development/kurento_js_merge_project/lib'")}()}catch(error){"undefined"==typeof getScreenConstraints&&(console.warn("screen sharing is not available"),getScreenConstraints=function(e,t){t(new Error("This library is not enabled for screen sharing"))})}var MEDIA_CONSTRAINTS={audio:!0,video:{mandatory:{maxWidth:640,maxFrameRate:15,minFrameRate:15}}},ua=window&&window.navigator?window.navigator.userAgent:"",parser=new UAParser(ua);inherits(WebRtcPeer,EventEmitter),Object.defineProperties(WebRtcPeer.prototype,{enabled:{enumerable:!0,get:function(){return this.audioEnabled&&this.videoEnabled},set:function(e){this.audioEnabled=this.videoEnabled=e}},audioEnabled:createEnableDescriptor("Audio"),videoEnabled:createEnableDescriptor("Video")}),WebRtcPeer.prototype.getLocalSessionDescriptor=function(){var e=this.peerConnection;return e?e.localDescription:void 0},WebRtcPeer.prototype.getRemoteSessionDescriptor=function(){var e=this.peerConnection;return e?e.remoteDescription:void 0},WebRtcPeer.prototype.getLocalStream=function(e){var t=this.peerConnection;return t?t.getLocalStreams()[e||0]:void 0},WebRtcPeer.prototype.getRemoteStream=function(e){var t=this.peerConnection;return t?t.getRemoteStreams()[e||0]:void 0},inherits(WebRtcPeerRecvonly,WebRtcPeer),inherits(WebRtcPeerSendonly,WebRtcPeer),inherits(WebRtcPeerSendrecv,WebRtcPeer),exports.bufferizeCandidates=bufferizeCandidates,exports.WebRtcPeerRecvonly=WebRtcPeerRecvonly,exports.WebRtcPeerSendonly=WebRtcPeerSendonly,exports.WebRtcPeerSendrecv=WebRtcPeerSendrecv;
