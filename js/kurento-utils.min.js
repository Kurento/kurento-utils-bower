...
function noop(e){e&&console.error(e)}function trackStop(e){e.stop&&e.stop()}function streamStop(e){e.getTracks().forEach(trackStop)}function bufferizeCandidates(e,n){var t=[];return e.addEventListener("signalingstatechange",function(){if("stable"===this.signalingState)for(;t.length;){var e=t.shift();this.addIceCandidate(e.candidate,e.callback,e.callback)}}),function(r,i){switch(i=i||n,e.signalingState){case"closed":i(new Error("PeerConnection object is closed"));break;case"stable":if(e.remoteDescription){e.addIceCandidate(r,i,i);break}default:t.push({candidate:r,callback:i})}}}function WebRtcPeer(e,n,t){function r(){if(a){var e=v.getRemoteStreams()[0],n=e?URL.createObjectURL(e):"";a.src=n,console.log("Remote URL:",n)}}function i(){m.emit("streamended",this)}function o(){d&&s&&m.showLocalVideo(),d&&(d.addEventListener("ended",i),v.addStream(d)),l&&(l.addEventListener("ended",i),v.addStream(l)),"sendonly"==e&&(e="sendrecv"),t()}function c(e){getUserMedia(recursive(MEDIA_CONSTRAINTS,e),function(e){d=e,o()},t)}if(!(this instanceof WebRtcPeer))return new WebRtcPeer(e,n,t);WebRtcPeer.super_.call(this),n instanceof Function&&(t=n,n=void 0),n=n||{},t=(t||noop).bind(this);var s=n.localVideo,a=n.remoteVideo,d=n.videoStream,l=n.audioStream,f=n.mediaConstraints,u=n.connectionConstraints,v=n.peerConnection,p=n.sendSource||"webcam",b=recursive({iceServers:freeice()},n.configuration),h=n.onstreamended;h&&this.on("streamended",h);var g=n.onicecandidate;g&&this.on("icecandidate",g);var R=n.oncandidategatheringdone;R&&this.on("candidategatheringdone",R),v||(v=new RTCPeerConnection(b)),Object.defineProperty(this,"peerConnection",{get:function(){return v}}),Object.defineProperty(this,"currentFrame",{get:function(){if(a){if(a.readyState<a.HAVE_CURRENT_DATA)throw new Error("No video stream data available");var e=document.createElement("canvas");return e.width=a.videoWidth,e.height=a.videoHeight,e.getContext("2d").drawImage(a,0,0),e}}});var m=this,S=[],P=!1;v.addEventListener("icecandidate",function(e){var n=e.candidate;EventEmitter.listenerCount(m,"icecandidate")||EventEmitter.listenerCount(m,"candidategatheringdone")?n?(m.emit("icecandidate",n),P=!1):P||(m.emit("candidategatheringdone"),P=!0):P||(S.push(n),n||(P=!0))}),this.on("newListener",function(e,n){if("icecandidate"===e||"candidategatheringdone"===e)for(;S.length;){var t=S.shift();!t==("candidategatheringdone"===e)&&n(t)}});var y=bufferizeCandidates(v);this.addIceCandidate=function(e,n){var t=new RTCIceCandidate(e);console.log("ICE candidate received"),n=(n||noop).bind(this),y(t,n)},this.generateOffer=function(n){n=n.bind(this);var t=parser.getBrowser(),r="Firefox"===t.name&&t.version>34?{offerToReceiveAudio:"sendonly"!==e,offerToReceiveVideo:"sendonly"!==e}:{mandatory:{OfferToReceiveAudio:"sendonly"!==e,OfferToReceiveVideo:"sendonly"!==e},optional:[{DtlsSrtpKeyAgreement:!0}]},i=recursive(r,u);console.log("constraints: "+JSON.stringify(i)),v.createOffer(function(e){console.log("Created SDP offer"),v.setLocalDescription(e,function(){console.log("Local description set",e.sdp),n(null,e.sdp,m.processAnswer.bind(m))},n)},n,i)},this.getLocalSessionDescriptor=function(){return v.localDescription},this.getRemoteSessionDescriptor=function(){return v.remoteDescription},this.showLocalVideo=function(){s.src=URL.createObjectURL(d),s.muted=!0},this.processAnswer=function(e,n){n=(n||noop).bind(this);var t=new RTCSessionDescription({type:"answer",sdp:e});return console.log("SDP answer received, setting remote description"),"closed"==v.signalingState?n("PeerConnection is closed"):void v.setRemoteDescription(t,function(){r(),n()},n)},this.processOffer=function(e,n){n=n.bind(this);var t=new RTCSessionDescription({type:"offer",sdp:e});return console.log("SDP offer received, setting remote description"),"closed"==v.signalingState?n("PeerConnection is closed"):void v.setRemoteDescription(t,function(){r();var e=recursive({},u);console.log("constraints: "+JSON.stringify(e)),v.createAnswer(function(e){console.log("Created SDP answer"),v.setLocalDescription(e,function(){console.log("Local description set",e.sdp),n(null,e.sdp)},n)},n,e)},n)},"recvonly"===e||d||l?setTimeout(o,0):"webcam"==p||f?c(f):getScreenConstraints(p,function(e,n){return e?t(e):void c(n)}),this.on("_dispose",function(){s&&(s.src=""),a&&(a.src="")})}function createEnableDescriptor(e){var n="get"+e+"Tracks";return{enumerable:!0,get:function(){if(this.peerConnection){var e=this.peerConnection.getLocalStreams();if(e.length){for(var t,r=0;t=e[r];r++)for(var i,o=t[n](),c=0;i=o[c];c++)if(!i.enabled)return!1;return!0}}},set:function(e){function t(n){n.enabled=e}this.peerConnection.getLocalStreams().forEach(function(e){e[n]().forEach(t)})}}}function WebRtcPeerRecvonly(e,n){return this instanceof WebRtcPeerRecvonly?void WebRtcPeerRecvonly.super_.call(this,"recvonly",e,n):new WebRtcPeerRecvonly(e,n)}function WebRtcPeerSendonly(e,n){return this instanceof WebRtcPeerSendonly?void WebRtcPeerSendonly.super_.call(this,"sendonly",e,n):new WebRtcPeerSendonly(e,n)}function WebRtcPeerSendrecv(e,n){return this instanceof WebRtcPeerSendrecv?void WebRtcPeerSendrecv.super_.call(this,"sendrecv",e,n):new WebRtcPeerSendrecv(e,n)}var freeice=require("freeice"),inherits=require("inherits"),UAParser=require("ua-parser-js"),EventEmitter=require("events").EventEmitter,recursive=require("merge").recursive.bind(void 0,!0);try{!function(){throw new Error("Cannot find module 'kurento-browser-extensions' from '/var/lib/jenkins/workspace/kurento-js-merge-project/lib'")}()}catch(error){"undefined"==typeof getScreenConstraints&&(console.warn("screen sharing is not available"),getScreenConstraints=function(e,n){n(new Error("This library is not enabled for screen sharing"))})}var MEDIA_CONSTRAINTS={audio:!0,video:{mandatory:{maxWidth:640,maxFrameRate:15,minFrameRate:15}}},ua=window&&window.navigator&&window.navigator.userAgent?window.navigator.userAgent:"",parser=new UAParser(ua);inherits(WebRtcPeer,EventEmitter),Object.defineProperty(WebRtcPeer.prototype,"enabled",{enumerable:!0,get:function(){return this.audioEnabled&&this.videoEnabled},set:function(e){this.audioEnabled=this.videoEnabled=e}}),Object.defineProperty(WebRtcPeer.prototype,"audioEnabled",createEnableDescriptor("Audio")),Object.defineProperty(WebRtcPeer.prototype,"videoEnabled",createEnableDescriptor("Video")),WebRtcPeer.prototype.getLocalStream=function(e){return this.peerConnection?this.peerConnection.getLocalStreams()[e||0]:void 0},WebRtcPeer.prototype.getRemoteStream=function(e){return this.peerConnection?this.peerConnection.getRemoteStreams()[e||0]:void 0},WebRtcPeer.prototype.dispose=function(){console.log("Disposing WebRtcPeer");var e=this.peerConnection;if(e){if("closed"==e.signalingState)return;e.getLocalStreams().forEach(streamStop),e.close()}this.emit("_dispose")},inherits(WebRtcPeerRecvonly,WebRtcPeer),inherits(WebRtcPeerSendonly,WebRtcPeer),inherits(WebRtcPeerSendrecv,WebRtcPeer),exports.bufferizeCandidates=bufferizeCandidates,exports.WebRtcPeerRecvonly=WebRtcPeerRecvonly,exports.WebRtcPeerSendonly=WebRtcPeerSendonly,exports.WebRtcPeerSendrecv=WebRtcPeerSendrecv;
