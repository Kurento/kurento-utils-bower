...
function noop(e){if(e){if(console.trace)return console.trace(e);console.error(e)}}function trackStop(e){e.stop&&e.stop()}function streamStop(e){e.getTracks().forEach(trackStop)}function WebRtcPeer(e,t,r){function n(e,t,r){return e?console.error(e):void b.processSdpAnswer(t,r)}WebRtcPeer.super_.call(this);var o,c,i,s,a,l,d,u,f,p=recursive({iceServers:freeice()},WebRtcPeer.prototype.server);switch(e){case"recv":e="recvonly";break;case"send":e="sendonly"}for(;arguments.length&&!arguments[arguments.length-1];)arguments.length--;arguments.length>2?(console.warn("Positional parameters are deprecated for WebRtcPeer"),o=arguments[1],c=arguments[2],i=arguments[3],s=arguments[4],a=arguments[5],l=arguments[6],d=arguments[7]):(t instanceof Function&&(r=t,t=void 0),t=t||{},o=t.localVideo,c=t.remoteVideo,i=t.onsdpoffer,s=t.onerror,a=t.mediaConstraints,l=t.videoStream,d=t.audioStream,u=t.connectionConstraints,f=t.peerConnection,p=recursive(p,t.configuration)),s&&this.on("error",s),i&&this.on("sdpoffer",i),f||(f=new RTCPeerConnection(p)),Object.defineProperty(this,"peerConnection",{get:function(){return f}});var b=this,R=!1;f.addEventListener("icecandidate",function(e){return e.candidate?void(R=!1):void(R||(R=!0,b.emit("sdpoffer",f.localDescription.sdp,n),console.log("ICE negotiation completed")))}),this.start=function(t,r){if(l&&o&&(o.src=URL.createObjectURL(l),o.muted=!0),l&&f.addStream(l),d&&f.addStream(d),t instanceof Function){if(r)throw new Error("Nothing can be defined after the callback");r=t,t=void 0}"sendonly"==e&&(e="sendrecv"),t=recursive({mandatory:{OfferToReceiveAudio:"sendonly"!==e,OfferToReceiveVideo:"sendonly"!==e},optional:[{DtlsSrtpKeyAgreement:!0}]},t),console.log("constraints: "+JSON.stringify(t)),r=(r||noop).bind(this),f.createOffer(function(e){console.log("Created SDP offer"),f.setLocalDescription(e,function(){console.log("Local description set",e),r(null,b)},r)},r,t)},"recvonly"===e||l?b.start(u,r):(a=recursive({audio:!0,video:{mandatory:{maxWidth:640,maxFrameRate:15,minFrameRate:15}}},a),getUserMedia(a,function(e){l=e,b.start(u,r)},r||noop)),this.on("_dispose",function(){o&&(o.src=""),c&&(c.src="")}),this.on("_processSdpAnswer",function(e){c&&(c.src=e,console.log("Remote URL:",e))})}function WebRtcPeerRecvonly(e){WebRtcPeerRecvonly.super_.call(this,"recvonly",e)}function WebRtcPeerSendonly(e){WebRtcPeerSendonly.super_.call(this,"sendonly",e)}function WebRtcPeerSendrecv(e){WebRtcPeerSendrecv.super_.call(this,"sendrecv",e)}var freeice=require("freeice"),inherits=require("inherits"),EventEmitter=require("events").EventEmitter,recursive=require("merge").recursive;inherits(WebRtcPeer,EventEmitter),WebRtcPeer.prototype.server={},WebRtcPeer.prototype.getLocalStream=function(e){return this.peerConnection?this.peerConnection.getLocalStreams()[e||0]:void 0},WebRtcPeer.prototype.getRemoteStream=function(e){return this.peerConnection?this.peerConnection.getRemoteStreams()[e||0]:void 0},WebRtcPeer.prototype.dispose=function(){console.log("Disposing WebRtcPeer");var e=this.peerConnection;e&&("closed"!=e.signalingState&&e.close(),e.getLocalStreams().forEach(streamStop)),this.emit("_dispose")},WebRtcPeer.prototype.processSdpAnswer=function(e,t){var r=new RTCSessionDescription({type:"answer",sdp:e});console.log("SDP answer received, setting remote description"),t=t||noop;var n=this,o=this.peerConnection;o.setRemoteDescription(r,function(){var e=URL.createObjectURL(o.getRemoteStreams()[0]);n.emit("_processSdpAnswer",e),t()},t)},Object.defineProperty(WebRtcPeer.prototype,"enabled",{enumerable:!0,get:function(){return this.audioEnabled&&this.videoEnabled},set:function(e){this.audioEnabled=this.videoEnabled=e}}),Object.defineProperty(WebRtcPeer.prototype,"audioEnabled",{enumerable:!0,get:function(){if(this.peerConnection){var e=this.peerConnection.getLocalStreams();if(e.length){for(var t,r=0;t=e[r];r++)for(var n,o=0;n=t.getAudioTracks()[o];o++)if(!n.enabled)return!1;return!0}}},set:function(e){this.peerConnection.getLocalStreams().forEach(function(t){t.getAudioTracks().forEach(function(t){t.enabled=e})})}}),Object.defineProperty(WebRtcPeer.prototype,"videoEnabled",{enumerable:!0,get:function(){if(this.peerConnection){var e=this.peerConnection.getLocalStreams();if(e.length){for(var t,r=0;t=e[r];r++)for(var n,o=0;n=t.getVideoTracks()[o];o++)if(!n.enabled)return!1;return!0}}},set:function(e){this.peerConnection.getLocalStreams().forEach(function(t){t.getVideoTracks().forEach(function(t){t.enabled=e})})}}),WebRtcPeer.start=function(e,t,r,n,o,c,i,s,a,l,d){var u={localVideo:t,remoteVideo:r,onsdpoffer:n,onerror:o,mediaConstraints:c,videoStream:i,audioStream:s,configuration:a,connectionConstraints:l};return new WebRtcPeer(e,u,d)},WebRtcPeer.startRecvOnly=function(e,t,r,n,o,c,i){return WebRtcPeer.start("recvonly",null,e,t,r,n,null,null,o,c,i)},WebRtcPeer.startSendOnly=function(e,t,r,n,o,c,i){return WebRtcPeer.start("sendonly",e,null,t,r,n,null,null,o,c,i)},WebRtcPeer.startSendRecv=function(e,t,r,n,o,c,i,s){return WebRtcPeer.start("sendrecv",e,t,r,n,o,null,null,c,i,s)},inherits(WebRtcPeerRecvonly,WebRtcPeer),inherits(WebRtcPeerSendonly,WebRtcPeer),inherits(WebRtcPeerSendrecv,WebRtcPeer),module.exports=WebRtcPeer,WebRtcPeer.WebRtcPeer=WebRtcPeer,WebRtcPeer.WebRtcPeerRecvonly=WebRtcPeerRecvonly,WebRtcPeer.WebRtcPeerSendonly=WebRtcPeerSendonly,WebRtcPeer.WebRtcPeerSendrecv=WebRtcPeerSendrecv;
