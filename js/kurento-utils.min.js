...
function noop(e){e&&console.error(e)}function trackStop(e){e.stop&&e.stop()}function streamStop(e){e.getTracks().forEach(trackStop)}function bufferizeCandidates(e,t){function n(){if("stable"===this.signalingState)for(;i.length;){var e=i.shift();this.addIceCandidate(e.candidate,e.callback,e.callback)}this.removeEventListener("signalingstatechange",n)}var i=[];return e.addEventListener("signalingstatechange",n),function(n,r){switch(r=r||t,e.signalingState){case"closed":r(new Error("PeerConnection object is closed"));break;case"stable":if(e.remoteDescription){e.addIceCandidate(n,r,r);break}default:i.push({candidate:n,callback:r})}}}function getFrame(e){var t=document.createElement("canvas");t.width=e.videoWidth,t.height=e.videoHeight;var n=t.getContext("2d");return n.drawImage(e,0,0),t.toDataURL()}function WebRtcPeer(e,t,n){function i(){E.emit("streamended",this)}function r(e){function t(e){var n=e.candidate;EventEmitter.listenerCount(E,"icecandidate")||EventEmitter.listenerCount(E,"candidategatheringdone")?n?E.emit("icecandidate",n):E.emit("candidategatheringdone"):r.push(n),n||this.removeEventListener("icecandidate",t)}var n=new RTCPeerConnection(e);w=bufferizeCandidates(n);var r=[];return this.on("newListener",function(e,t){if("icecandidate"===e||"candidategatheringdone"===e)for(;r.length;){var n=r.shift();!n==("candidategatheringdone"===e)&&t(n)}}),n.addEventListener("icecandidate",t),n.addEventListener("iceconnectionstatechange",o),n.addEventListener("signalingstatechange",onsignalingstatechange),l&&(l.addEventListener("ended",i),n.addStream(l)),u&&(u.addEventListener("ended",i),n.addStream(u)),n}function o(){if("connected"==this.iceConnectionState){if(d){var e=d.style;e.backgroundImage;d.src=URL.createObjectURL(this.getRemoteStreams()[0]),console.log("Remote URL: "+d.src)}S.close(),S=this,this.removeEventListener("iceconnectionstatechange",o)}}function i(){E.emit("streamended",this)}function c(){"closed"===S.signalingState&&n('The peer connection object is in "closed" state. This is most likely due to an invocation of the dispose method before accepting in the dialogue'),l&&s&&E.showLocalVideo(),l&&(l.addEventListener("ended",i),S.addStream(l)),u&&(u.addEventListener("ended",i),S.addStream(u)),"sendonly"===e&&(e="sendrecv"),n()}function a(e){e=Array.prototype.slice.call(arguments),e.unshift(MEDIA_CONSTRAINTS),getUserMedia(recursive.apply(void 0,e),function(e){l=e,c()},n)}if(!(this instanceof WebRtcPeer))return new WebRtcPeer(e,t,n);WebRtcPeer.super_.call(this),t instanceof Function&&(n=t,t=void 0),t=t||{},n=(n||noop).bind(this);var s=t.localVideo,d=t.remoteVideo,l=t.videoStream,u=t.audioStream,f=t.mediaConstraints,h=(t.connectionConstraints,t.sendSource||"webcam"),v=uuid.v4(),g=recursive({iceServers:freeice()},t.configuration),p=t.onstreamended;p&&this.on("streamended",p);var b=t.onicecandidate;b&&this.on("icecandidate",b);var m=t.oncandidategatheringdone;m&&this.on("candidategatheringdone",m);var R,S=t.peerConnection;Object.defineProperties(this,{peerConnection:{get:function(){return S}},remoteVideo:{get:function(){return d}},localVideo:{get:function(){return s}},currentFrame:{get:function(){if(d){if(d.readyState<d.HAVE_CURRENT_DATA)throw new Error("No video stream data available");var e=document.createElement("canvas");return e.width=d.videoWidth,e.height=d.videoHeight,e.getContext("2d").drawImage(d,0,0),e}}}});var w,E=this;this.addIceCandidate=function(e,t){var n=new RTCIceCandidate(e);console.log("ICE candidate received"),t=(t||noop).bind(this),w(n,t)},this.generateOffer=function(e){e=e.bind(this),R=r(g);var t=parser.getBrowser();"Firefox"===t.name&&t.version>34;console.log("constraints:",constraints),R.createOffer(function(t){console.log("Created SDP offer"),R.setLocalDescription(t,function(){console.log("Local description set:",t.sdp),e(null,t.sdp,E.processAnswer.bind(E))},e)},e,constraints)},this.getLocalSessionDescriptor=function(){return S.localDescription},this.getRemoteSessionDescriptor=function(){return S.remoteDescription},this.showLocalVideo=function(){s.src=URL.createObjectURL(l),s.muted=!0},this.processAnswer=function(e,t){t=(t||noop).bind(this);var n=new RTCSessionDescription({type:"answer",sdp:e});return console.log("SDP answer received, setting remote description"),"closed"===R.signalingState?t("PeerConnection is closed"):void R.setRemoteDescription(n,t,t)},this.processOffer=function(e,t){t=t.bind(this);var n=new RTCSessionDescription({type:"offer",sdp:e});console.log("SDP offer received, setting remote description"),R=r(g),R.setRemoteDescription(n,function(){R.createAnswer(function(e){console.log("Created SDP answer"),R.setLocalDescription(e,function(){console.log("Local description set",e.sdp),S=R,t(null,e.sdp)},t)},t)},t)},"recvonly"===e||l||u?setTimeout(c,0):"webcam"===h?a(f):getScreenConstraints(h,function(e,t){return e?n(e):void a(t,f)},v),this.on("_dispose",function(){s&&(s.pause(),s.src="",s.load()),d&&(d.pause(),d.src="",d.load()),E.removeAllListeners(),void 0!==window.cancelChooseDesktopMedia&&window.cancelChooseDesktopMedia(v)})}function createEnableDescriptor(e){var t="get"+e+"Tracks";return{enumerable:!0,get:function(){if(this.peerConnection){var e=this.peerConnection.getLocalStreams();if(e.length){for(var n,i=0;n=e[i];i++)for(var r,o=n[t](),c=0;r=o[c];c++)if(!r.enabled)return!1;return!0}}},set:function(e){function n(t){t.enabled=e}this.peerConnection.getLocalStreams().forEach(function(e){e[t]().forEach(n)})}}}function WebRtcPeerRecvonly(e,t){return this instanceof WebRtcPeerRecvonly?void WebRtcPeerRecvonly.super_.call(this,"recvonly",e,t):new WebRtcPeerRecvonly(e,t)}function WebRtcPeerSendonly(e,t){return this instanceof WebRtcPeerSendonly?void WebRtcPeerSendonly.super_.call(this,"sendonly",e,t):new WebRtcPeerSendonly(e,t)}function WebRtcPeerSendrecv(e,t){return this instanceof WebRtcPeerSendrecv?void WebRtcPeerSendrecv.super_.call(this,"sendrecv",e,t):new WebRtcPeerSendrecv(e,t)}var freeice=require("freeice"),inherits=require("inherits"),UAParser=require("ua-parser-js"),uuid=require("uuid"),EventEmitter=require("events").EventEmitter,recursive=require("merge").recursive.bind(void 0,!0);try{!function(){throw new Error("Cannot find module 'kurento-browser-extensions' from '/var/lib/jenkins/workspace/Development/kurento_js_merge_project/lib'")}()}catch(error){"undefined"==typeof getScreenConstraints&&(console.warn("screen sharing is not available"),getScreenConstraints=function(e,t){t(new Error("This library is not enabled for screen sharing"))})}var MEDIA_CONSTRAINTS={audio:!0,video:{mandatory:{maxWidth:640,maxFrameRate:15,minFrameRate:15}}},ua=window&&window.navigator?window.navigator.userAgent:"",parser=new UAParser(ua);inherits(WebRtcPeer,EventEmitter),Object.defineProperties(WebRtcPeer.prototype,{enabled:{enumerable:!0,get:function(){return this.audioEnabled&&this.videoEnabled},set:function(e){this.audioEnabled=this.videoEnabled=e}},audioEnabled:createEnableDescriptor("Audio"),videoEnabled:createEnableDescriptor("Video")}),WebRtcPeer.prototype.getLocalStream=function(e){return this.peerConnection?this.peerConnection.getLocalStreams()[e||0]:void 0},WebRtcPeer.prototype.getRemoteStream=function(e){return this.peerConnection?this.peerConnection.getRemoteStreams()[e||0]:void 0},WebRtcPeer.prototype.dispose=function(){console.log("Disposing WebRtcPeer");var e=this.peerConnection;if(e){if("closed"===e.signalingState)return;e.getLocalStreams().forEach(streamStop),e.close()}this.emit("_dispose")},inherits(WebRtcPeerRecvonly,WebRtcPeer),inherits(WebRtcPeerSendonly,WebRtcPeer),inherits(WebRtcPeerSendrecv,WebRtcPeer),exports.bufferizeCandidates=bufferizeCandidates,exports.WebRtcPeerRecvonly=WebRtcPeerRecvonly,exports.WebRtcPeerSendonly=WebRtcPeerSendonly,exports.WebRtcPeerSendrecv=WebRtcPeerSendrecv;
