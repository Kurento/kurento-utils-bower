...
function noop(e){e&&console.error(e)}function trackStop(e){e.stop&&e.stop()}function streamStop(e){e.getTracks().forEach(trackStop)}function bufferizeCandidates(e,n){var t=[];return e.addEventListener("signalingstatechange",function(){if("stable"===this.signalingState)for(;t.length;){var e=t.shift();this.addIceCandidate(e.candidate,e.callback,e.callback)}}),function(o,i){switch(i=i||n,e.signalingState){case"closed":i(new Error("PeerConnection object is closed"));break;case"stable":if(e.remoteDescription){e.addIceCandidate(o,i,i);break}default:t.push({candidate:o,callback:i})}}}function WebRtcPeer(e,n,t){function o(){if(a){var e=v.getRemoteStreams()[0],n=e?URL.createObjectURL(e):"";a.pause(),a.src=n,a.load(),console.log("Remote URL:",n)}}function i(){S.emit("streamended",this)}function r(){"closed"===v.signalingState&&t('The peer connection object is in "closed" state. This is most likely due to an invocation of the dispose method before accepting in the dialogue'),d&&s&&S.showLocalVideo(),d&&(d.addEventListener("ended",i),v.addStream(d)),l&&(l.addEventListener("ended",i),v.addStream(l));var n=parser.getBrowser();"sendonly"!==e||"Chrome"!==n.name&&"Chromium"!==n.name||39!==n.major||(e="sendrecv"),t()}function c(e){void 0===e&&(e=MEDIA_CONSTRAINTS),getUserMedia(e,function(e){d=e,r()},t)}if(!(this instanceof WebRtcPeer))return new WebRtcPeer(e,n,t);WebRtcPeer.super_.call(this),n instanceof Function&&(t=n,n=void 0),n=n||{},t=(t||noop).bind(this);var s=n.localVideo,a=n.remoteVideo,d=n.videoStream,l=n.audioStream,u=n.mediaConstraints,f=n.connectionConstraints,v=n.peerConnection,p=n.sendSource||"webcam",h=uuid.v4(),b=recursive({iceServers:freeice()},n.configuration),g=n.onstreamended;g&&this.on("streamended",g);var m=n.onicecandidate;m&&this.on("icecandidate",m);var R=n.oncandidategatheringdone;R&&this.on("candidategatheringdone",R),v||(v=new RTCPeerConnection(b)),Object.defineProperties(this,{peerConnection:{get:function(){return v}},remoteVideo:{get:function(){return a}},localVideo:{get:function(){return s}},currentFrame:{get:function(){if(a){if(a.readyState<a.HAVE_CURRENT_DATA)throw new Error("No video stream data available");var e=document.createElement("canvas");return e.width=a.videoWidth,e.height=a.videoHeight,e.getContext("2d").drawImage(a,0,0),e}}}});var S=this,w=[],P=!1;v.addEventListener("icecandidate",function(e){var n=e.candidate;EventEmitter.listenerCount(S,"icecandidate")||EventEmitter.listenerCount(S,"candidategatheringdone")?n?(S.emit("icecandidate",n),P=!1):P||(S.emit("candidategatheringdone"),P=!0):P||(w.push(n),n||(P=!0))}),this.on("newListener",function(e,n){if("icecandidate"===e||"candidategatheringdone"===e)for(;w.length;){var t=w.shift();!t==("candidategatheringdone"===e)&&n(t)}});var C=bufferizeCandidates(v);this.addIceCandidate=function(e,n){var t=new RTCIceCandidate(e);console.log("ICE candidate received"),n=(n||noop).bind(this),C(t,n)},this.generateOffer=function(n){n=n.bind(this);var t=parser.getBrowser(),o=!0,i=!0;u&&(o="boolean"==typeof u.audio?u.audio:!0,i="boolean"==typeof u.video?u.video:!0);var r="Firefox"===t.name&&t.version>34?{offerToReceiveAudio:"sendonly"!==e&&o,offerToReceiveVideo:"sendonly"!==e&&i}:{mandatory:{OfferToReceiveAudio:"sendonly"!==e&&o,OfferToReceiveVideo:"sendonly"!==e&&i},optional:[{DtlsSrtpKeyAgreement:!0}]},c=recursive(r,f);console.log("constraints: "+JSON.stringify(c)),v.createOffer(function(e){console.log("Created SDP offer"),v.setLocalDescription(e,function(){console.log("Local description set",e.sdp),n(null,e.sdp,S.processAnswer.bind(S))},n)},n,c)},this.getLocalSessionDescriptor=function(){return v.localDescription},this.getRemoteSessionDescriptor=function(){return v.remoteDescription},this.showLocalVideo=function(){s.src=URL.createObjectURL(d),s.muted=!0},this.processAnswer=function(e,n){n=(n||noop).bind(this);var t=new RTCSessionDescription({type:"answer",sdp:e});return console.log("SDP answer received, setting remote description"),"closed"===v.signalingState?n("PeerConnection is closed"):void v.setRemoteDescription(t,function(){o(),n()},n)},this.processOffer=function(e,n){n=n.bind(this);var t=new RTCSessionDescription({type:"offer",sdp:e});return console.log("SDP offer received, setting remote description"),"closed"===v.signalingState?n("PeerConnection is closed"):void v.setRemoteDescription(t,function(){o(),v.createAnswer(function(e){console.log("Created SDP answer"),v.setLocalDescription(e,function(){console.log("Local description set",e.sdp),n(null,e.sdp)},n)},n)},n)},"recvonly"===e||d||l?setTimeout(r,0):"webcam"===p?c(u):getScreenConstraints(p,function(e,n){return e?t(e):(constraints=[u],constraints.unshift(n),void c(recursive.apply(void 0,constraints)))},h),this.on("_dispose",function(){s&&(s.pause(),s.src="",s.load()),a&&(a.pause(),a.src="",a.load()),S.removeAllListeners(),void 0!==window.cancelChooseDesktopMedia&&window.cancelChooseDesktopMedia(h)})}function createEnableDescriptor(e){var n="get"+e+"Tracks";return{enumerable:!0,get:function(){if(this.peerConnection){var e=this.peerConnection.getLocalStreams();if(e.length){for(var t,o=0;t=e[o];o++)for(var i,r=t[n](),c=0;i=r[c];c++)if(!i.enabled)return!1;return!0}}},set:function(e){function t(n){n.enabled=e}this.peerConnection.getLocalStreams().forEach(function(e){e[n]().forEach(t)})}}}function WebRtcPeerRecvonly(e,n){return this instanceof WebRtcPeerRecvonly?void WebRtcPeerRecvonly.super_.call(this,"recvonly",e,n):new WebRtcPeerRecvonly(e,n)}function WebRtcPeerSendonly(e,n){return this instanceof WebRtcPeerSendonly?void WebRtcPeerSendonly.super_.call(this,"sendonly",e,n):new WebRtcPeerSendonly(e,n)}function WebRtcPeerSendrecv(e,n){return this instanceof WebRtcPeerSendrecv?void WebRtcPeerSendrecv.super_.call(this,"sendrecv",e,n):new WebRtcPeerSendrecv(e,n)}var freeice=require("freeice"),inherits=require("inherits"),UAParser=require("ua-parser-js"),uuid=require("uuid"),EventEmitter=require("events").EventEmitter,recursive=require("merge").recursive.bind(void 0,!0);try{!function(){throw new Error("Cannot find module 'kurento-browser-extensions' from '/var/lib/jenkins/workspace/Development/kurento_js_merge_project/lib'")}()}catch(error){"undefined"==typeof getScreenConstraints&&(console.warn("screen sharing is not available"),getScreenConstraints=function(e,n){n(new Error("This library is not enabled for screen sharing"))})}var MEDIA_CONSTRAINTS={audio:!0,video:{width:640,framerate:15}},ua=window&&window.navigator?window.navigator.userAgent:"",parser=new UAParser(ua);inherits(WebRtcPeer,EventEmitter),Object.defineProperties(WebRtcPeer.prototype,{enabled:{enumerable:!0,get:function(){return this.audioEnabled&&this.videoEnabled},set:function(e){this.audioEnabled=this.videoEnabled=e}},audioEnabled:createEnableDescriptor("Audio"),videoEnabled:createEnableDescriptor("Video")}),WebRtcPeer.prototype.getLocalStream=function(e){return this.peerConnection?this.peerConnection.getLocalStreams()[e||0]:void 0},WebRtcPeer.prototype.getRemoteStream=function(e){return this.peerConnection?this.peerConnection.getRemoteStreams()[e||0]:void 0},WebRtcPeer.prototype.dispose=function(){console.log("Disposing WebRtcPeer");var e=this.peerConnection;try{if(e){if("closed"===e.signalingState)return;e.getLocalStreams().forEach(streamStop),e.close()}}catch(n){console.warn("Exception disposing webrtc peer "+n)}this.emit("_dispose")},inherits(WebRtcPeerRecvonly,WebRtcPeer),inherits(WebRtcPeerSendonly,WebRtcPeer),inherits(WebRtcPeerSendrecv,WebRtcPeer),exports.bufferizeCandidates=bufferizeCandidates,exports.WebRtcPeerRecvonly=WebRtcPeerRecvonly,exports.WebRtcPeerSendonly=WebRtcPeerSendonly,exports.WebRtcPeerSendrecv=WebRtcPeerSendrecv;
