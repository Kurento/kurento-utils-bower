...
function noop(e){e&&console.error(e)}function trackStop(e){e.stop&&e.stop()}function streamStop(e){e.getTracks().forEach(trackStop)}function bufferizeCandidates(e,n){function t(){if("stable"===this.signalingState)for(;r.length;){var e=r.shift();this.addIceCandidate(e.candidate,e.callback,e.callback)}this.removeEventListener("signalingstatechange",t)}var r=[];return e.addEventListener("signalingstatechange",t),function(t,i){switch(i=i||n,e.signalingState){case"closed":i(new Error("PeerConnection object is closed"));break;case"stable":if(e.remoteDescription){e.addIceCandidate(t,i,i);break}default:r.push({candidate:t,callback:i})}}}function WebRtcPeer(e,n,t){function r(){P.emit("streamended",this)}function i(e){function n(e){var t=e.candidate;EventEmitter.listenerCount(P,"icecandidate")||EventEmitter.listenerCount(P,"candidategatheringdone")?t?P.emit("icecandidate",t):P.emit("candidategatheringdone"):i.push(t),t||this.removeEventListener("icecandidate",n)}var t=new RTCPeerConnection(e);E=bufferizeCandidates(t);var i=[];return P.on("newListener",function(e,n){if("icecandidate"===e||"candidategatheringdone"===e)for(;i.length;){var t=i.shift();!t==("candidategatheringdone"===e)&&n(t)}}),t.addEventListener("icecandidate",n),t.addEventListener("iceconnectionstatechange",o),l&&(l.addEventListener("ended",r),t.addStream(l)),u&&(u.addEventListener("ended",r),t.addStream(u)),t}function o(){if("connected"===this.iceConnectionState||"completed"===this.iceConnectionState){if(this.removeEventListener("iceconnectionstatechange",o),d){if(d.readyState>=d.HAVE_CURRENT_DATA){var e=d.style,n=e.backgroundImage;e.backgroundImage="url('"+P.currentFrame.toDataURL()+"')",n&&d.addEventListener("playing",function t(){d.removeEventListener("playing",t),e.backgroundImage=n})}d.src=URL.createObjectURL(this.getRemoteStreams()[0]),console.log("Remote URL: "+d.src)}S&&S.close(),S=this,P.emit("connected")}}function r(){P.emit("streamended",this)}function c(){P.showLocalVideo(),"sendonly"===e&&(e="sendrecv"),t()}function a(e){e=Array.prototype.slice.call(arguments),e.unshift(MEDIA_CONSTRAINTS),getUserMedia(recursive.apply(void 0,e),function(e){l=e,c()},t)}if(!(this instanceof WebRtcPeer))return new WebRtcPeer(e,n,t);WebRtcPeer.super_.call(this),n instanceof Function&&(t=n,n=void 0),n=n||{},t=(t||noop).bind(this);var s=n.localVideo,d=n.remoteVideo,l=n.videoStream,u=n.audioStream,f=n.mediaConstraints,v=(n.connectionConstraints,n.sendSource||"webcam"),h=uuid.v4(),p=recursive({iceServers:freeice()},n.configuration),g=n.onstreamended;g&&this.on("streamended",g);var b=n.onicecandidate;b&&this.on("icecandidate",b);var m=n.oncandidategatheringdone;m&&this.on("candidategatheringdone",m);var R,S=n.peerConnection;Object.defineProperties(this,{peerConnection:{get:function(){return S}},remoteVideo:{get:function(){return d}},localVideo:{get:function(){return s}},currentFrame:{get:function(){if(d){if(d.readyState<d.HAVE_CURRENT_DATA)throw new Error("No video stream data available");var e=document.createElement("canvas");return e.width=d.videoWidth,e.height=d.videoHeight,e.getContext("2d").drawImage(d,0,0),e}}}});var E,P=this;this.addIceCandidate=function(e,n){var t=new RTCIceCandidate(e);console.log("ICE candidate received"),n=(n||noop).bind(this),E(t,n)},this.generateOffer=function(n){n=n.bind(this),R=i(p);var t=parser.getBrowser(),r="Firefox"===t.name&&t.version>34,o=r?{offerToReceiveAudio:"sendonly"!==e,offerToReceiveVideo:"sendonly"!==e}:{mandatory:{OfferToReceiveAudio:"sendonly"!==e,OfferToReceiveVideo:"sendonly"!==e},optional:[{DtlsSrtpKeyAgreement:!0}]};console.log("constraints:",o),R.createOffer(function(e){console.log("Created SDP offer"),R.setLocalDescription(e,function(){console.log("Local description set:",e.sdp),n(null,e.sdp,P.processAnswer.bind(P))},n)},n,o)},this.showLocalVideo=function(){s&&l&&(s.src=URL.createObjectURL(l),s.muted=!0)},this.processAnswer=function(e,n){n=(n||noop).bind(this);var t=new RTCSessionDescription({type:"answer",sdp:e});return console.log("SDP answer received, setting remote description"),"closed"===R.signalingState?n("PeerConnection is closed"):void R.setRemoteDescription(t,n,n)},this.processOffer=function(e,n){n=n.bind(this);var t=new RTCSessionDescription({type:"offer",sdp:e});console.log("SDP offer received, setting remote description"),R=i(p),R.setRemoteDescription(t,function(){R.createAnswer(function(e){console.log("Created SDP answer"),R.setLocalDescription(e,function(){console.log("Local description set",e.sdp),n(null,e.sdp)},n)},n)},n)},"recvonly"===e||l||u?setTimeout(c,0):"webcam"===v?a(f):getScreenConstraints(v,function(e,n){return e?t(e):void a(n,f)},h),this.dispose=function(){if(console.log("Disposing WebRtcPeer"),S){if("closed"===S.signalingState)return;S.getLocalStreams().forEach(streamStop),S.close(),S=void 0}s&&(s.pause(),s.src="",s.load()),d&&(d.pause(),d.src="",d.load()),P.removeAllListeners(),void 0!==window.cancelChooseDesktopMedia&&window.cancelChooseDesktopMedia(h)}}function trackSetEnable(e){e.enabled=this.valueOf()}function createEnableDescriptor(e){var n="get"+e+"Tracks";return{enumerable:!0,get:function(){if(this.peerConnection){var e=this.peerConnection.getLocalStreams();if(e.length){for(var t,r=0;t=e[r];r++)for(var i,o=t[n](),c=0;i=o[c];c++)if(!i.enabled)return!1;return!0}}},set:function(e){this.peerConnection.getLocalStreams().forEach(function(t){t[n]().forEach(trackSetEnable,e)})}}}function WebRtcPeerRecvonly(e,n){return this instanceof WebRtcPeerRecvonly?void WebRtcPeerRecvonly.super_.call(this,"recvonly",e,n):new WebRtcPeerRecvonly(e,n)}function WebRtcPeerSendonly(e,n){return this instanceof WebRtcPeerSendonly?void WebRtcPeerSendonly.super_.call(this,"sendonly",e,n):new WebRtcPeerSendonly(e,n)}function WebRtcPeerSendrecv(e,n){return this instanceof WebRtcPeerSendrecv?void WebRtcPeerSendrecv.super_.call(this,"sendrecv",e,n):new WebRtcPeerSendrecv(e,n)}var freeice=require("freeice"),inherits=require("inherits"),UAParser=require("ua-parser-js"),uuid=require("uuid"),EventEmitter=require("events").EventEmitter,recursive=require("merge").recursive.bind(void 0,!0);try{!function(){throw new Error("Cannot find module 'kurento-browser-extensions' from '/var/lib/jenkins/workspace/Development/kurento_js_merge_project/lib'")}()}catch(error){"undefined"==typeof getScreenConstraints&&(console.warn("screen sharing is not available"),getScreenConstraints=function(e,n){n(new Error("This library is not enabled for screen sharing"))})}var MEDIA_CONSTRAINTS={audio:!0,video:{mandatory:{maxWidth:640,maxFrameRate:15,minFrameRate:15}}},ua=window&&window.navigator?window.navigator.userAgent:"",parser=new UAParser(ua);inherits(WebRtcPeer,EventEmitter),Object.defineProperties(WebRtcPeer.prototype,{enabled:{enumerable:!0,get:function(){return this.audioEnabled&&this.videoEnabled},set:function(e){this.audioEnabled=this.videoEnabled=e}},audioEnabled:createEnableDescriptor("Audio"),videoEnabled:createEnableDescriptor("Video")}),WebRtcPeer.prototype.getLocalSessionDescriptor=function(){var e=this.peerConnection;return e?e.localDescription:void 0},WebRtcPeer.prototype.getRemoteSessionDescriptor=function(){var e=this.peerConnection;return e?e.remoteDescription:void 0},WebRtcPeer.prototype.getLocalStream=function(e){var n=this.peerConnection;return n?n.getLocalStreams()[e||0]:void 0},WebRtcPeer.prototype.getRemoteStream=function(e){var n=this.peerConnection;return n?n.getRemoteStreams()[e||0]:void 0},inherits(WebRtcPeerRecvonly,WebRtcPeer),inherits(WebRtcPeerSendonly,WebRtcPeer),inherits(WebRtcPeerSendrecv,WebRtcPeer),exports.bufferizeCandidates=bufferizeCandidates,exports.WebRtcPeerRecvonly=WebRtcPeerRecvonly,exports.WebRtcPeerSendonly=WebRtcPeerSendonly,exports.WebRtcPeerSendrecv=WebRtcPeerSendrecv;
